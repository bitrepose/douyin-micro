...
type Client interface {
	Feed(ctx context.Context, req *video.FeedRequset, callOptions ...callopt.Option) (r *video.FeedResponse, err error)
...
func (p *kVideoServiceClient) Feed(ctx context.Context, req *video.FeedRequset, callOptions ...callopt.Option) (r *video.FeedResponse, err error) {
